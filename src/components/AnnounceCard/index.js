...
import { Root, User, Avatar, Info, AuthorName, Location, Meta, SubHeader, Action, Price, Body,
                        ...
                        <ImageWrapper className={clsx(classes.image)}>
                            {announce.getImages.length > 0 ? (
                                <div>
                                    ...
                                    />
                                    <ImageCounter>
                                        <i.CameraAlt color='primary' />
                                        <div style={{ color: "#2C65F6" }}>{announce.getCountImages}</div>
                                    </ImageCounter>
                                </div>
                            ) :
                                <ImagePlaceholder>
