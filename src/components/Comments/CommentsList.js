...
const CommentsList = ({ comments, moreLink, className }) => {
    ...
    return (
        <div className={clsx(classes)}>
            ...
            <ul style={{ listStyleType: 'none', margin: '1rem 0', height: '300px', overflowY: 'scroll' }}>
                {comments &&
          comments.filter(filterComments).map((comment, index) => {
                  ...
                  <li key={index}>
                      ...
                      <div className="d-flex align-items-top my-2">
                          <div style={{ display: 'flex', width: '80%', wordWrap: 'break-word' }}>
                              {!isOwn && (
                                  <div
                                      onClick={() => complain(comment.getID)}
                                      style={{
                                          color: '#999999',
                                          display: 'flex',
    ...
    return (
        ...
        >
            ...
            <DialogActions>
                ...
                <Button variant="contained" startIcon={<RemoveCircleIcon />} onClick={handleCallback}>
