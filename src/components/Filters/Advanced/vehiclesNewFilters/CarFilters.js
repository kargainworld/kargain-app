...
const CarFilters = ({ control, watch, errors, ...props }) => {
    ...
    return (
        <div>
            <Row>
                <Col sm="1">
                    <FieldWrapperMarket label={t('vehicles:price')}>
                        <SliderInput
                            name="price"
                ...
                <Col sm={2}>
                    <FieldWrapperMarket label={t('vehicles:type')}>
                        <SelectInput
                            name="mileageType"
                ...
                <Col sm={1}>
                    <FieldWrapperMarket label={t(`vehicles:${mileageType?.label}`)}>
                        <SliderInput
                            name="mileage"
                ...
                <Col sm={2}>
                    <FieldWrapperMarket label={t('vehicles:gear-box')}>
                        <SelectInput
                ...
                <Col sm={2}>
                    <FieldWrapperMarket label={t('vehicles:gas')}>
                        <SelectInput
                ...
                <Col sm={1}>
                    <FieldWrapperMarket label={t('vehicles:cylinder')}>
                        <SliderInput
                ...
                <Col sm={2}>
                    <FieldWrapperMarket label={t('vehicles:power')}>
                        <SliderInput
                            name="powerKw"
                            min={0}
                            max={200}
                ...
                <Col sm={1}>
                    <FieldWrapperMarket label={t('vehicles:radius')}>
                        <SliderInput
                            name="radius"
                            min={0}
                            max={500}
            ...
            <Row>
                <Col sm={2}>
                    <FieldWrapperMarket label={t('vehicles:country')}>
                        <SelectCountryFlags
                            name="countrySelect"
                            errors={errors}
                            control={control}
                ...
                <Col sm={2}>
                    <FieldWrapperMarket label={t('vehicles:address')}>
                        <SearchLocationInput
                            name="address"
                ...
                <Col sm={2}>
                    <FieldWrapperMarket label={t('vehicles:equipments')}>
                        <SelectInput
                            name="equipments"
                ...
                <Col sm={2}>
                    <FieldWrapperMarket label={t('vehicles:class_emission')}>
                        <SelectInput
                            name="emission"
                ...
                <Col sm={2}>
                    <FieldWrapperMarket label={t('vehicles:co2-consumption')}>
                        <SliderInput
                            name="consumptionGkm"
                            min={0}
                            max={200}
                ...
                <Col sm={2}>
                    <FieldWrapperMarket label={t('vehicles:doors_quantity')}>
                        <SliderInput
                            name="doors"
                            min={1}
                            max={10}
            ...
            <Row>
                <Col sm={2}>
                    <FieldWrapperMarket label={t('vehicles:seats_quantity')}>
                        <SliderInput
                            name="seats"
                            min={1}
                            max={10}
                ...
                <Col sm={2}>
                    <FieldWrapperMarket label={t('vehicles:paint')}>
                        <SelectInput
                            name="paint"
                            control={control}
                ...
                <Col sm={2}>
                    <FieldWrapperMarket label={t('vehicles:external_color')}>
                        <SelectInput
                            name="externalColor"
                ...
                <Col sm={2}>
                    <FieldWrapperMarket label={t('vehicles:internal_color')}>
                        <SelectInput
                            name="internalColor"
                            options={formData.RadioChoicesMaterials}
                            control={control}
                ...
                <Col sm={2}>
                    <FieldWrapperMarket label={t('vehicles:vehicle-state')}>
                        <SelectInput
