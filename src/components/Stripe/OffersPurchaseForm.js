            ...
            <div className="row">
                <div className="col-12">
                    <div style={{ fontSize: '24px', margintLeft: '15px' }}>
                        {authenticatedUser.getHasProPlan && <div className="my-2" />}
                    </div>

                    {enableSubscribe && (
                        <div style={{ marginLeft: '-15px' }}>
                            <h4 className="step-title" style={{ fontSize: '20px', color: 'black' }}>
                            ...
                            {isMobile ? (
                                <div style={{ marginTop: '15px' }}>
                                    ...
                                    {isSelectedOffer && <StripePurchase disabled={!isSelectedOffer} offer={selectedOffer} />}
                                </div>
                            ) : (
